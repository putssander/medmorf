...
const CACHE_NAME = 'medmorf-app-v53';
...
const APP_SHELL = [
    ...
    './src/anonymize-prompts.js',
    './src/benchmark-handler.js',
    './src/stt-store.js',
    './src/try-example.js',
    './tests/metrics.js',
...
const CDN_DEPS = [
    ...
    // JSEP/WebGPU wasm glue (loaded at runtime by the extern-wasm ORT builds)
    'https://cdn.jsdelivr.net/npm/onnxruntime-web@1.26.0-dev.20260416-b7804b056c/dist/ort-wasm-simd-threaded.jsep.mjs',
    'https://cdn.jsdelivr.net/npm/onnxruntime-web@1.26.0-dev.20260416-b7804b056c/dist/ort-wasm-simd-threaded.jsep.wasm',
