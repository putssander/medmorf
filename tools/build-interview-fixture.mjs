...
// Transcript timestamps like "[13:51]" are structure, not identifiers: flagging one is harmless.
const timestamps = [...new Set((text.match(/\b\d{2}:\d{2}\b/g) || []))];
const allowed = [...timestamps, 'Interviewer', 'Respondent', 'huisarts', 'chirurg', 'oncoloog', 'mammacareverpleegkundige', 'bedrijfsarts', 'fysiotherapeut', 'oncologiefysiotherapeut', 'verpleegkundige', 'verpleegkundig specialist', 'gynaecoloog', 'medisch psycholoog', 'radiotherapeut', 'radioloog', 'patholoog', 'leidinggevende', 'werkgever', 'buurvrouw', 'havo', 'Google', 'Nederland', 'Nederlandse'];
